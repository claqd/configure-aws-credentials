...
function exportCredentials(params, output){
...
function exportRegion(region, output) {
...
async function run() {
  try {
    ...
    const roleOutputCredentials = core.getInput('role-output-credentials', { required: false }) || false;
    ...
    exportRegion(region, roleOutputCredentials);
    ...
    if (accessKeyId) {
      ...
      exportCredentials({accessKeyId, secretAccessKey, sessionToken}, roleOutputCredentials);
    }
    ...
    if (roleToAssume) {
      ...
      exportCredentials(roleCredentials, roleOutputCredentials);
